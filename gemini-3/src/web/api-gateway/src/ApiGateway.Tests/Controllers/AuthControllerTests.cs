...
{
    // Interface to make the controller testable
    public interface IOpenIddictRequestProvider
    {
        OpenIddictRequest GetRequest(HttpContext context);
    }

    // Default implementation that uses the real OpenIddict extension
    public class OpenIddictRequestProvider : IOpenIddictRequestProvider
    {
    ...
    {
        private readonly IOpenIddictRequestProvider _requestProvider;

        // Default constructor for production use
        public AuthController() : this(new OpenIddictRequestProvider())
        {
        }

        // Constructor for testing
        public AuthController(IOpenIddictRequestProvider requestProvider)
        {
        ...
        {
            var request = _requestProvider.GetRequest(HttpContext) ??
            ...
            if (!scopes.Contains(OpenIddictConstants.Scopes.OfflineAccess))
            {
                ...
                claimsPrincipal.SetScopes(scopesList); // Fixed: use scopesList instead of scopes
            } else {
